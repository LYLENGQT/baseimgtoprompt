    ...
    <div>
      <div
        className={cn(
          ...
          isDragging ? "border-primary bg-accent/50" : "border-border hover:border-primary/60",
        )}
        onDragOver={(e) => {
          e.preventDefault();
          setIsDragging(true);
      ...
      >
        ...
        <div className="space-y-1">
          <p className="text-base font-medium text-foreground">Drop your fashion image here or click to browse</p>
          <p className="text-sm text-foreground/70">Supports JPG, PNG, WEBP (max 10MB)</p>
        </div>
        <input
          ref={inputRef}
          type="file"
